	...
	<footer class="fbg-footer" role="contentinfo">
		<div class="fbg-container fbg-footer__grid">
			...
			<div class="fbg-footer__col">
				...
				<ul>
					...
					<li><span class="fbg-muted"><?php esc_html_e( 'Affiliate Program (coming soon)', 'free-backlinks-generator' ); ?></span></li>
			...
			<div class="fbg-footer__col">
				...
				<ul>
					...
					<li><span class="fbg-muted"><?php esc_html_e( 'Cookie Policy', 'free-backlinks-generator' ); ?></span></li>
					<li><span class="fbg-muted"><?php esc_html_e( 'GDPR Notice', 'free-backlinks-generator' ); ?></span></li>
		...
		<div class="fbg-footer__bar">
			<div class="fbg-container fbg-footer__bar-inner">
				<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?>. <?php esc_html_e( 'Free to join. Real backlinks. Real results.', 'free-backlinks-generator' ); ?></p>
			</div>
		</div>
	</footer>
	<?php
