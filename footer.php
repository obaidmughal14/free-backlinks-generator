	...
	<footer class="fbg-footer" role="contentinfo">
		...
		<div class="fbg-footer__bar">
			...
			<div class="fbg-container fbg-footer__bar-inner">
				...
				<p class="fbg-footer__copyright-line">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?>. <?php echo esc_html( get_theme_mod( 'fbg_footer_tagline', 'Free to join. Real backlinks. Real results.' ) ); ?></p>

				<?php if ( get_theme_mod( 'fbg_footer_show_credit', true ) ) : ?>
				<p class="fbg-footer__credit"><?php echo esc_html( get_theme_mod( 'fbg_footer_credit_lead', 'Designed and developed by' ) ); ?>
					<?php
					$credit_url = get_theme_mod( 'fbg_footer_credit_url', 'https://devigontech.com' );
					$credit_url = $credit_url ? esc_url( $credit_url ) : '';
					$credit_name = get_theme_mod( 'fbg_footer_credit_name', 'Devigon Tech' );
					if ( $credit_url ) {
						echo ' <a href="' . $credit_url . '" target="_blank" rel="noopener noreferrer">' . esc_html( $credit_name ) . '</a>';
					} else {
						echo ' ' . esc_html( $credit_name );
					}
					?>
				</p>
				<?php endif; ?>
