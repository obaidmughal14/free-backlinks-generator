...
?>
<main id="main-content" class="fbg-submit fbg-container">
	<h1><?php esc_html_e( 'Submit a Guest Post', 'free-backlinks-generator' ); ?></h1>
	<p class="fbg-submit__sub"><?php esc_html_e( 'Write original content in your niche with your backlinks embedded naturally. Posts are reviewed within 24–48 hours.', 'free-backlinks-generator' ); ?></p>
	<div class="fbg-info-bar"><?php printf( esc_html__( 'Free plan: You can include up to %d backlinks per post.', 'free-backlinks-generator' ), (int) $max_l ); ?></div>
	<div class="fbg-alert fbg-alert--error" id="fbg-submit-alert" role="alert" hidden></div>
	<form id="fbg-submit-form" class="fbg-form fbg-submit-form">
		<div class="fbg-field">
			<label for="fbg-post-title"><?php esc_html_e( 'Post Title', 'free-backlinks-generator' ); ?> *</label>
			<input type="text" id="fbg-post-title" name="title" required maxlength="120">
		...
		<div class="fbg-field">
			...
			<small><?php esc_html_e( 'Max 5MB. JPG, PNG, WebP.', 'free-backlinks-generator' ); ?></small>
		</div>
		<div class="fbg-field">
			<label for="fbg-post-content"><?php esc_html_e( 'Guest Post Content', 'free-backlinks-generator' ); ?> *</label>
			<?php
			wp_editor(
				'',
				'fbg_post_content',
